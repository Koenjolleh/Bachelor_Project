...
exports.JsonDayByActivities = async (dataDay, id_day, id_dataset, id_location, id_service) => {
    try {
        ...
        // data = pre_output.sort((a,b) => { return a.id_activity - b.id_activity; });
        data = pre_output;
        return data;
...
exports.JsonMoreCategoriesByActivities = async (dataDay, openinghours, id_dataset, id_location, id_service) => {
    try {
        let obj = {};
        let pre_output = [];
        let pre_people = [];
