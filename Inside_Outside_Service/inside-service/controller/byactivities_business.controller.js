...
//Helpers
const queryBuilder = require('../query_builders/byactivities_business.query_builder');
    ...
    passport.authenticate('jwt', { session: false }, async (err, user, info) => {
        ...
        if (info !== undefined) {
            ...
            try {
                ...
                queryString = queryBuilder.DayByActivitiesB(id_location, id_day, id_activity, id_service, returning_customer, id_dataset);
    ...
    passport.authenticate('jwt', { session: false }, async (err, user, info) => {
        ...
        if (info !== undefined) {
            ...
            try {
                ...
                queryString = queryBuilder.TypeDaysByActivitiesB(id_location, id_day_type, id_activity, id_service, returning_customer, id_dataset);
    ...
    passport.authenticate('jwt', { session: false }, async (err, user, info) => {
        ...
        if (info !== undefined) {
            ...
            try {
                ...
                queryString = queryBuilder.FullDaysByActivitiesB(id_location, id_activity, id_service, returning_customer, id_dataset);
