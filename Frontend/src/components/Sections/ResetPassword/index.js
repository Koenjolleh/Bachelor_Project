            ...
            <Fragment>
                ...
                <Grid className={classes.container}>
                    <Paper className={classes.paper}>

                        {
                            statusResponse === 403 && (
                                <div className={classes.containerContent}>
                                    <Typography variant="h4" component="h4" className={classes.typographyError}>
                                        {messageFromServer}
                                    </Typography>
                        ...
                        {
                            isLoading && (
                                <Typography variant="h4" component="h4" className={classes.loading}>
                                    <Spinner />
                                </Typography>
                            )
                        }

                        {
                            statusResponse === 200 && statusResponse !== 403 && statusResponse !== 404 && statusResponse !== 422 && (
                                <div className={classes.containerContent}>
                                    <div>
                                        <Typography variant="h4" component="h4" className={classes.typographySuccess}>
                                            {messageFromServer}
                                        </Typography>
                                    </div>
                                    <div className={classes.containerButton}>
