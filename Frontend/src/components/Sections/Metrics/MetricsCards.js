...
class MetricsCards extends Component { 
    state = {
        ...
        cardSelected: null,
        potentialGain: [
            'Sit down customers have an average transaction of €21, and on a comparable Saturday, there is 92 sit down customers. Take-away customers has an average transaction of €8. If Sunday fulfills same potential as a Saturday increased earnings will be €129.000/year.', 
            'Right now engagement is 3 times higher with wine shelves on the right. If left wine shelves fulfill same potential as right shelves.\n Potential extra clients as on left shelves =190/week, \nAverage transaction takeaway = €8, \n 8x190x52 = €79.000/year', 
            '', '', '', '', '', '', '', ''],
...
export default withStyles(styles)(withRouter(MetricsCards));