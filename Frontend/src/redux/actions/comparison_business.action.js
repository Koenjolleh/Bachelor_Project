...
import {
    GET_COMPARISON_BUSINESS_DAY_REQUEST, GET_COMPARISON_BUSINESS_DAY_SUCCESS, GET_COMPARISON_BUSINESS_DAY_FAILURE,
    GET_COMPARISON_BUSINESS_TYPEDAYS_REQUEST, GET_COMPARISON_BUSINESS_TYPEDAYS_SUCCESS, GET_COMPARISON_BUSINESS_TYPEDAYS_FAILURE,
    GET_COMPARISON_BUSINESS_FULLDAYS_REQUEST, GET_COMPARISON_BUSINESS_FULLDAYS_SUCCESS, GET_COMPARISON_BUSINESS_FULLDAYS_FAILURE
} from '../action_types';
...
function getDataByDayByActivity(idLocation, selectedDay, activityDay, service, returningCustomer, defaultDataset, idForm) {
    ...
    return async (dispatch, getState) => {
        dispatch({ type: GET_COMPARISON_BUSINESS_DAY_REQUEST });
        ...
        try {
            ...
            dispatch({ type: GET_COMPARISON_BUSINESS_DAY_SUCCESS, payload: { dataByDayByActivity: data_byday_byactivity.data.data, idForm } });

        } catch(error) {
            dispatch(returnErrors(error.response.data, error.response.status, GET_COMPARISON_BUSINESS_DAY_FAILURE));
        }
    }
}
...
function getDataByTypeDaysByActivity(idLocation, typeDay, activityDay, service, returningCustomer, defaultDataset, idForm) {
    ...
    return async (dispatch, getState) => {
        dispatch({ type: GET_COMPARISON_BUSINESS_TYPEDAYS_REQUEST });
        ...
        try {
            ...
            dispatch({ type: GET_COMPARISON_BUSINESS_TYPEDAYS_SUCCESS, payload: { dataByTypeDaysByActivity: data_typedays_byactivity.data.data, idForm } });

        } catch(error) {
            dispatch(returnErrors(error.response.data, error.response.status, GET_COMPARISON_BUSINESS_TYPEDAYS_FAILURE));
        }
    }
}
...
function getDataFullDaysByActivity(idLocation, activityDay, service, returningCustomer, defaultDataset, idForm) {
    ...
    return async (dispatch, getState) => {
        dispatch({ type: GET_COMPARISON_BUSINESS_FULLDAYS_REQUEST });
        ...
        try {
            ...
            dispatch({ type: GET_COMPARISON_BUSINESS_FULLDAYS_SUCCESS, payload: { dataFullDaysByActivity: data_fulldays_byactivity.data.data, idForm } });

        } catch(error) {
            dispatch(returnErrors(error.response.data, error.response.status, GET_COMPARISON_BUSINESS_FULLDAYS_FAILURE));
        }
    }
}
...
/****** getByActivitiesData **********/
export const getByActivitiesBusinessData = (idLocation, day, activities, service, returningCustomer, defaultDataset, idForm) => {
    const id_location = idLocation;
    const id_day = day;
