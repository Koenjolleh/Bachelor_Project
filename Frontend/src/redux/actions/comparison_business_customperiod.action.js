...
import {
    GET_COMPARISON_CUSTOMPERIOD_BUSINESS_DAY_REQUEST, GET_COMPARISON_CUSTOMPERIOD_BUSINESS_DAY_SUCCESS, GET_COMPARISON_CUSTOMPERIOD_BUSINESS_DAY_FAILURE,
    GET_COMPARISON_CUSTOMPERIOD_BUSINESS_TYPEDAYS_REQUEST, GET_COMPARISON_CUSTOMPERIOD_BUSINESS_TYPEDAYS_SUCCESS, GET_COMPARISON_CUSTOMPERIOD_BUSINESS_TYPEDAYS_FAILURE,
    GET_COMPARISON_CUSTOMPERIOD_BUSINESS_FULLDAYS_REQUEST, GET_COMPARISON_CUSTOMPERIOD_BUSINESS_FULLDAYS_SUCCESS, GET_COMPARISON_CUSTOMPERIOD_BUSINESS_FULLDAYS_FAILURE
} from '../action_types';
...
function getDataByDayByPeriodByActivity(idLocation, selectedDay, periodsDay, activityDay, service, returningCustomer, defaultDataset, idForm) {
    ...
    return async (dispatch, getState) => {
        dispatch({ type: GET_COMPARISON_CUSTOMPERIOD_BUSINESS_DAY_REQUEST });
        ...
        try {
            ...
            dispatch({ type: GET_COMPARISON_CUSTOMPERIOD_BUSINESS_DAY_SUCCESS, payload: { dataByDayByPeriodByActivity: data_day_period_activity.data.data, idForm } });

        } catch(error) {
            dispatch(returnErrors(error.response.data, error.response.status, GET_COMPARISON_CUSTOMPERIOD_BUSINESS_DAY_FAILURE));
        }
    }
}
...
function getDataByTypeDaysByPeriodByActivity(idLocation, typeDay, periodsDay, activityDay, service, returningCustomer, defaultDataset, idForm) {
    ...
    return async (dispatch, getState) => {
        dispatch({ type: GET_COMPARISON_CUSTOMPERIOD_BUSINESS_TYPEDAYS_REQUEST });
        ...
        try {
            ...
            dispatch({ type: GET_COMPARISON_CUSTOMPERIOD_BUSINESS_TYPEDAYS_SUCCESS, payload: { dataByTypeDaysByPeriodByActivity: data_typedays_period_activity.data.data, idForm } });

        } catch(error) {
            dispatch(returnErrors(error.response.data, error.response.status, GET_COMPARISON_CUSTOMPERIOD_BUSINESS_TYPEDAYS_FAILURE));
        }
    }
}
...
function getDataByFullDaysByPeriodByActivity(idLocation, periodsDay, activityDay, service, returningCustomer, defaultDataset, idForm) {
    ...
    return async (dispatch, getState) => {
        dispatch({ type: GET_COMPARISON_CUSTOMPERIOD_BUSINESS_FULLDAYS_REQUEST });
        ...
        try {
            ...
            dispatch({ type: GET_COMPARISON_CUSTOMPERIOD_BUSINESS_FULLDAYS_SUCCESS, payload: { dataByFullDaysByPeriodByActivity: data_fulldays_period_activity.data.data, idForm } });

        } catch(error) {
            dispatch(returnErrors(error.response.data, error.response.status, GET_COMPARISON_CUSTOMPERIOD_BUSINESS_FULLDAYS_FAILURE));
        }
    }
}
...
export const getByPeriodsByActivitiesBusinessData = (idLocation, day, periods, activities, service, returningCustomer, defaultDataset, idForm) => {
    const id_location = idLocation;
    const id_day = day;
